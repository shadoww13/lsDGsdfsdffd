...
// добавляем обработчики кнопок назад только если они есть
[backBtn, backBtn2, backBtn3, backBtn4].filter(Boolean).forEach(b => b.addEventListener('click', goBack));
...
function renderSelectPairs() {
  if (!pairsGrid || !pagination) return;
